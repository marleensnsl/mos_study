...
def page_welcome():
    ...
    and rate them on several perceptual dimensions. Some of these audio clips are spoken by human speakers, others are generated by AI speech synthesis systems.
